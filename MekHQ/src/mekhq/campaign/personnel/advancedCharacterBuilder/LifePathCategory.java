...
public enum LifePathCategory {
    ...
    SPECIAL_CITIZEN_WARRIORS("SPECIAL_CITIZEN_WARRIORS"),
    SPECIAL_COMBAT_PARALYSIS_IMPACT_FAME("SPECIAL_COMBAT_PARALYSIS_IMPACT_FAME"),
    ...
    SPECIAL_LIMITED_SCHOOLING("SPECIAL_LIMITED_SCHOOLING"),
    ...
    SPECIAL_POOR_SERFS("SPECIAL_POOR_SERFS"),
    ...
    SPECIAL_STAGE_3_NEEDS_CITIZENSHIP("SPECIAL_STAGE_3_NEEDS_CITIZENSHIP"),
